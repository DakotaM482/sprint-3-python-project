...
total_sales = 0
for sales_value in video_game_sales:
    total_sales = total_sales + sales_value[9]
avg_global_sales = total_sales / len(video_game_sales)
print(f"Average global sales:", avg_global_sales) # Average number of sales per each game 
